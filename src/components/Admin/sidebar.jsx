    ...
    return (
        ...
        >
            <ul className="flex flex-col gap-3">
                <button
                    className="p-5 rounded-lg hover:bg-green-200"
                    onClick={() => {
                ...
                {[
                    ...
                    <Link
                        ...
                        scroll={false}
                        className={`flex items-center p-5 gap-4 font-bold rounded-lg hover:bg-green-200 ${
                ...
                <li
                    className="flex items-center p-5 gap-4 font-bold rounded-lg text-green-500 hover:bg-green-200 cursor-pointer"
